...
def prepare_model(arch = 'ours', in_channel=1, 
    ...
    if arch == 'ours':
        ...
        print('Baseline AlexNet Archetecture!')
        image_embeding_model = AlexNet3D(in_channel=in_channel,feat_dim=feat_dim, expansion = expansion, type_name=type_name, norm_type=norm_type)
